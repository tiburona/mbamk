...
def build_status_message(statuses, user):
    ...
    responses = {
        'YAY': "scan was successfully uploaded to My Brain and Me!  You can view your scan.",
    ...
    message_text = "Dear {}, \nThank you for uploading your brain {} to My \
    Brain and Me! ".format(user.first_name, scan_word)
